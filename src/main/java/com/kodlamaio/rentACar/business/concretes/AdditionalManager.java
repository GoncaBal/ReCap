...
public class AdditionalManager implements AdditionalService{
	...
	public Result add(CreateAdditionalRequest createAdditionalRequest) {
		checkIfAdditionalExistName(createAdditionalRequest.getName());
	...
	private void checkIfAdditionalExistName(String name) {
		Additional currentAdditional = additionalRepository.findByName(name);
		if (currentAdditional!=null) {
			throw new BusinessException("ADDITIONAL.EXIST");
		}
	}
