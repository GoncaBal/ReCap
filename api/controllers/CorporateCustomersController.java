...
public class CorporateCustomersController {
	...
	DataResult<List<GetAllCorporateCustomersResponse>> getAll(@RequestParam int pageNumber, int pageSize){
		return this.corporateCustomerService.getAll(pageNumber,pageSize);
	}
